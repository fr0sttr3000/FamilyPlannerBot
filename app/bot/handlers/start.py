...
/donetasks — история выполненных задач (последние 30 дней)
/taskremind 3 2026-06-01 10:00 — напомнить о задаче
/taskassign 5 @masha — назначить задачу члену семьи

*Заметки:*
/notes — список заметок
/addnote Рецепт борща: ... — добавить заметку
/delnote 3 — удалить заметку
